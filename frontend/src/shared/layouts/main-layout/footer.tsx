...
export default function Footer({
  ...
  const footerVariant = variant ?? (pageConfig.footerVariant || "default");

  const getFooterStyles = () => {
    const baseStyles = "px-6 pt-[64px]";

    if (shouldUseContainer) {
      return cn(baseStyles, "container");
    }

    return footerVariant === "compact"
      ? cn(baseStyles, "mx-auto max-w-6xl")
      : cn(baseStyles, "mx-auto max-w-full");
  };

  return (
    <footer className={cn("border-t border-[#252632] bg-[#121218]", className)}>
